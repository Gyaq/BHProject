...
namespace API.Migrations
{
    ...
    [Migration("20210524000925_InitialCreate")]
            ...
            modelBuilder.Entity("API.Entities.AppReason", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1,
                            DateTime = new DateTime(2021, 5, 23, 17, 9, 25, 342, DateTimeKind.Local).AddTicks(9999),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = 2,
                            DateTime = new DateTime(2021, 5, 23, 17, 9, 25, 343, DateTimeKind.Local).AddTicks(1166),
                        ...
                        new
                        {
                            Id = 3,
                            CreatedBy = 4,
                            DateTime = new DateTime(2021, 5, 23, 17, 9, 25, 343, DateTimeKind.Local).AddTicks(1179),
            ...
            modelBuilder.Entity("API.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            JoinDate = new DateTime(2019, 5, 23, 17, 9, 25, 340, DateTimeKind.Local).AddTicks(835),
                            LastName = "Smith"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2020, 5, 23, 17, 9, 25, 341, DateTimeKind.Local).AddTicks(9305),
                            LastName = "Field"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2021, 3, 23, 17, 9, 25, 341, DateTimeKind.Local).AddTicks(9329),
                            LastName = "Gaberial"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2020, 2, 23, 17, 9, 25, 341, DateTimeKind.Local).AddTicks(9334),
                            LastName = "Weasley"
                        });
                });
